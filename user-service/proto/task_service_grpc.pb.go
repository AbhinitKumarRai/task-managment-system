...
const (
	...
	TaskService_DeleteAllTaskOfUser_FullMethodName = "/task.TaskService/DeleteAllTaskOfUser"
...
type TaskServiceClient interface {
	...
	DeleteAllTaskOfUser(ctx context.Context, in *DeleteAllTaskOfUserRequest, opts ...grpc.CallOption) (*DeleteAllTaskOfUserResponse, error)
...
func (c *taskServiceClient) DeleteAllTaskOfUser(ctx context.Context, in *DeleteAllTaskOfUserRequest, opts ...grpc.CallOption) (*DeleteAllTaskOfUserResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeleteAllTaskOfUserResponse)
	err := c.cc.Invoke(ctx, TaskService_DeleteAllTaskOfUser_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TaskServiceServer interface {
	...
	DeleteAllTaskOfUser(context.Context, *DeleteAllTaskOfUserRequest) (*DeleteAllTaskOfUserResponse, error)
...
func (UnimplementedTaskServiceServer) DeleteAllTaskOfUser(context.Context, *DeleteAllTaskOfUserRequest) (*DeleteAllTaskOfUserResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteAllTaskOfUser not implemented")
}
...
func _TaskService_DeleteAllTaskOfUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteAllTaskOfUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TaskServiceServer).DeleteAllTaskOfUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaskService_DeleteAllTaskOfUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskServiceServer).DeleteAllTaskOfUser(ctx, req.(*DeleteAllTaskOfUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TaskService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DeleteAllTaskOfUser",
			Handler:    _TaskService_DeleteAllTaskOfUser_Handler,
		},
		{
